...
def main() -> int:
    ...
    core_targets = (
        ...
        BuildTarget("plan3-feature-map", "gemstone-py Plan3 Feature Map", "Mapping improvement streams to modules, examples, docs, and release checks", (DOCS_DIR / "plan3-feature-map.md",)),
        BuildTarget("codegen", "gemstone-py Type-Safe Smalltalk Codegen", "Generating typed wrappers from Protocol classes", (DOCS_DIR / "codegen.md",)),
        BuildTarget("framework-adapters", "gemstone-py Framework Adapters", "Adding sync and async web framework adapters", (DOCS_DIR / "framework-adapters.md",)),
        ...
        BuildTarget(
            ...
            (
                ...
                DOCS_DIR / "plan3-feature-map.md",
                DOCS_DIR / "codegen.md",
                DOCS_DIR / "framework-adapters.md",
