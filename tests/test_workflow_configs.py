...
class WorkflowConfigTests(unittest.TestCase):
    ...
    def test_native_wheels_workflow_exists(self) -> None:
        ...
        self.assertIn("Checkout gemstone-rs path dependency", content)
        self.assertIn("https://github.com/unicompute/gemstone-rs.git", content)
        self.assertIn("../gemstone-rs", content)
        ...
        self.assertIn('extract_root.glob("**/Cargo.toml")', content)
        self.assertIn('name = "gemstone-py-native"', content)
        self.assertIn("run_native_rust_core_live_smoke.py", content)
        self.assertIn("--dry-run", content)
        self.assertIn('"pip"', content)
        self.assertIn('"wheel"', content)
        self.assertIn('"--wheel-dir"', content)
        ...
        self.assertIn("native_gci.rust_core_implementation()", content)
        self.assertIn("RustCoreSession", content)
