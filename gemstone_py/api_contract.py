...
CORE_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "InspectionResult": ("gemstone_py.inspection", "InspectionResult"),
    "MetricsCollector": ("gemstone_py.observability", "MetricsCollector"),
    "NULL_METRICS": ("gemstone_py.observability", "NULL_METRICS"),
    "NULL_SPAN": ("gemstone_py.observability", "NULL_SPAN"),
    "NULL_TRACER": ("gemstone_py.observability", "NULL_TRACER"),
    "NullMetrics": ("gemstone_py.observability", "NullMetrics"),
    "NullSpan": ("gemstone_py.observability", "NullSpan"),
    "NullTracer": ("gemstone_py.observability", "NullTracer"),
    "OpenTelemetryTracer": ("gemstone_py.observability", "OpenTelemetryTracer"),
    "PrometheusMetrics": ("gemstone_py.observability", "PrometheusMetrics"),
